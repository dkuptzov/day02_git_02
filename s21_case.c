...
void s21_case_f(char **str, param *param) {
    char *str_int;
    if (param->va_f == 0.0000005 && param->flag_dot == 0) param->va_f = 0.0000001;
...
void s21_case_g(char **str, param *param) {
    ...
    else if ((param_va_f >= pow(10, 6)) || ((param->type == 'e' || param->type == 'E') && (param->va_f >= 1 || param_va_f >= 1))) {
        printf("TUT1\n");
    ...
    else if ((param_va_f < pow(10, -4)) || ((param->type == 'e' || param->type == 'E') && (param->va_f < 1 || param_va_f < 1))) {
        printf("TUT2\n");
...
int s21_case_g_space(param *param) {
    int ret = 0;
    if (param->width > 1 && param->flag_space == 1 && param->va_f >= 0) param->width--;
    ...
    if (param->width > 0 && param->accuracy >= 0) {
        if (param->width == strlen && param->accuracy == strlen) {
            ...
            //
                ...
                param->width -= strlen;
                printf("TUT1111111111111111\n");
            }
            else {
                param->width -= strlen;
                param->accuracy = 0;
                printf("TUT22222222222222222\n");
            }
            //
        }
        else if (param->width >= param->accuracy) {
