...
s21_size_t s21_strcspn(const char *str1, const char *chars);        // 9
...
#define S21_SIZE_ERRORLIST 107

static const char *const s21_errlist[S21_SIZE_ERRORLIST] = {
    "Undefined error: 0",
